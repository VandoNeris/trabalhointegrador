...
CREATE TABLE IF NOT EXISTS consumocompra (
  id_consumo_compra INT GENERATED BY DEFAULT AS IDENTITY,
  quantidade INT NOT NULL,
  id_produto INT NOT NULL,
  id_compra INT NOT NULL,
  CONSTRAINT pk_consumocompra PRIMARY KEY (id_consumo_compra),
...
CREATE TABLE IF NOT EXISTS consumoservico (
  id_consumo_servico INT GENERATED BY DEFAULT AS IDENTITY,
  quantidade INT NOT NULL,
  id_produto INT NOT NULL,
  id_servico INT NOT NULL,
  CONSTRAINT pk_consumoservico PRIMARY KEY (id_consumo_servico),
