...
http_exc_pk = HTTPException(status_code=404, detail="Servico com o ID informado não foi encontrada.")
http_exc_fk = HTTPException(status_code=422, detail="Não foi possível criar servico: vínculo com outra tabela é inválido ou inexistente.")
