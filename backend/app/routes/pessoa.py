...
async def post_pessoa(pessoa: Pessoa, session: AsyncSession = Depends(get_session)):
...
async def put_pessoa(id_pessoa: int, pessoa: Pessoa, session: AsyncSession = Depends(get_session)):
...
async def delete_pessoa(id_pessoa: int, session: AsyncSession = Depends(get_session)):
...
async def get_pessoa(id_pessoa: int, session: AsyncSession = Depends(get_session)):
