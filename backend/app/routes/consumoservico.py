...
http_exc_pk = HTTPException(status_code=404, detail="ConsumoServico com o ID informado não foi encontrada.")
http_exc_fk = HTTPException(status_code=422, detail="Não foi possível criar a consumoservico: vínculo com outra tabela é inválido ou inexistente.")
